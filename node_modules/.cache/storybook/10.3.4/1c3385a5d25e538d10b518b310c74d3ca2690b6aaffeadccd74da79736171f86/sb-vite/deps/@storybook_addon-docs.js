...
import { st as definePreviewAddon10 } from "./components-BIbspUAi.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-DIZD1mMK.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-BFRodHai.js");
